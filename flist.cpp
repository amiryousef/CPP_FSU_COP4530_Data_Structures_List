/*
    flist.cpp
    01/01/12
    functionality test of List<T> and Iterator
    ...
    *isptr >> option;
	...
	if (BATCH) std::cout << option;
	  ...
	  case 'd':  case 'D': // Display
            if (BATCH) std::cout << '\n';
            DisplayContainerType(code0, code1);
	...
	if (BATCH) std::cout << option;
	  ...
	  case 't':  case 'T': // traverse
	    ...
	    switch(option)
	    {
	      case '1':
		x3.Merge(x1,pred);
		std::cout << "  x3.Merge(x1,pred);\n";
		break;
	      case '2':
		x3.Merge(x2,pred);
		std::cout << "  x3.Merge(x2,pred);\n";
		break;
	      case '3':
		x3.Merge(x3,pred);
		std::cout << "  x3.Merge(x3,pred);\n";
		break;
	    }
	    break;
    ...
    case 'c':
      switch(code1)
      {
        case '1':
          ...
          break;
        case '2':
          std::cout << "List2 < char, TLessThan < char > >";
          break;
        case '3':
          std::cout << "List2 < char, TGreaterThan < char > >";          
          break;
        default:
    ...
    case 's':
      switch(code1)
      {
        case '1':
          ...
          break;
        case '2':
          std::cout << "List2 < String, TLessThan < String > >";
          break;
        case '3':
          std::cout << "List2 < String, TGreaterThan < String > >";          
          break;
        default:
          std::cerr << " [bad code1 passed to DisplayPrompt()]";
      }
